defmodule ToTheWonderWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ToTheWonderWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ToTheWonderWeb.Gettext, "errors", msg, opts)
    end
  end
